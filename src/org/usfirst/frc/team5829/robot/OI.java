...
public class OI {
	...
	public OI(){
		...
		/*
		btnY.whileHeld(new Shoot(2000));
		btn2Y.whileHeld(new Shoot(2000));
		*/
		...
		btnB.whenReleased(new AngleManual());
		...
		btn2Y.whileHeld(new Shoot(3000));
		btn2A.whileHeld(new Shoot(2500));
