...
public class OI {
	...
	public OI(){
		...
		btnY.whileHeld(new Shoot(1)); //these need to be changed to RPM
		btnB.whileHeld(new Shoot(0.5));//change to RPM
		btnA.whileHeld(new Shoot(0.3));//change to RPM
		...
		btnL3.toggleWhenActive(new ShifterLowGear());
